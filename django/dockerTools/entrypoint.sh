...
watchfiles --filter python 'gunicorn --workers 3 --bind 0.0.0.0:8000 mainApp.wsgi:application' &  
daphne -u /app/django/sockets/daphne.sock mainApp.asgi:application
